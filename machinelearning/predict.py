...
def main():
    ...
    XIdxs = [0, 1, 2, 3, 4, 5]
    XNames = ["Dep", "Twitter", "Spotify", "SpotifySpecial", "Discogs", "DaysPlays"]
    Xs = [depfeatures, twitter_features, spotify_features, spotify_special, discogs_features, days_plays_features]
    Y = labels
